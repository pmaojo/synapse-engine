...
class DIContainer:
    ...
    def embedding_service(self):
        if "embedding_service" not in self._services:
            ...
            if embedding_type == "kv":
                ...
                from synapse.infrastructure.persistence.kv_embeddings import KVEmbeddingGenerator
                ...
                from synapse.infrastructure.persistence.embeddings import EmbeddingGenerator
    ...
    def translation_service(self):
        if "translation_service" not in self._services:
            from synapse.domain.services.translation_service import TranslationService
