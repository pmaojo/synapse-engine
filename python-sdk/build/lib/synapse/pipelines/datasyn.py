...
from synapse.application.pipelines.engine import PipelineStrategy, PipelineResult
...
class DataSynPipeline(PipelineStrategy):
    ...
    def run(self, input_data: str, **kwargs) -> PipelineResult:
        ...
        """
        import time
        from synapse.grpc.client import get_client
    ...
    def _process_csv(self, filepath: Path, logs: List[str], namespace: str = "default") -> List[Tuple[str, str, str]]:
        ...
        """
        from synapse.storage.embeddings import EmbeddingGenerator
        from synapse.storage.vector_store import VectorStore
        from synapse.grpc.client import get_client
        from synapse.domain.services.ontology import OntologyService
        from synapse.validation.ontology_validator import OntologyValidator
    ...
    def _owl_reasoning(self, recent_triples: List[Tuple]) -> List[Tuple[str, str, str]]:
        ...
        try:
            from synapse.core.ontology import OntologyService
